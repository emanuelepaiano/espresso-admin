...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'device' => ['type' => 'string', 'length' => 17, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['group_id'], 'references' => ['groups', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'group_id' => 1,
            'enabled' => 1,
            'created' => '2017-03-20 00:16:57',
            'modified' => '2017-03-20 00:16:57'
        ],
    ];
}
